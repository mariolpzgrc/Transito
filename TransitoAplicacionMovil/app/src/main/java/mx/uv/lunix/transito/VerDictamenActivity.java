...
public class VerDictamenActivity extends AppCompatActivity {
    ...
    private class WSGETDictamenTask extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
            responses = HttpUtils.getDictamenId(folio);
            return null;
        }
    ...
    private void resultadoDictameGET() {
        if(responses != null && !responses.isError() && responses.getResult() != null) {
            if(responses.getResult().contains("idReporte")){
                dictamen = new Gson().fromJson(responses.getResult(), Dictamen.class);
